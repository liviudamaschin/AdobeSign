...
namespace AdobeSignRESTClient
{
    public class AdobeSignREST : IAdobeSignREST
    {
        ...
        /// <inheritdoc />
        public Task<SigningUrlResponse> GetAgreementSigningUrl(string agreementId)
        {
        ...
        /// <inheritdoc />
        public Task<TransientDocument> UploadTransientDocument(string fileName, byte[] file,
