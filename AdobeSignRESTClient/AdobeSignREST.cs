...
namespace AdobeSignRESTClient
{
    public class AdobeSignREST : IAdobeSignREST
    {
        ...
        public async Task<SigningUrlResponse> GetAgreementSigningUrl(string agreementId)
        {
            
            var request = new RestRequest($"{_apiEndpointVer}/agreements/{agreementId}/signingUrls", Method.GET);
            request.AddHeader("Authorization", $"Bearer {AccessToken}");
            request.AddHeader("Content-Type", "application/json");

            IRestResponse<SigningUrlResponse> result = _restClient.Execute<SigningUrlResponse>(request);
        ...
        public async Task<TransientDocument> UploadTransientDocument(string fileName, byte[] file,
