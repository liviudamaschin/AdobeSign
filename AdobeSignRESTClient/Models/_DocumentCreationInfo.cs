...
{
    public class _DocumentCreationInfo
    {
        /// <summary>
        ...
        /// </summary>
        public List<ParticipantInfo> recipientSetInfos { get; set; }
        ...
        /// </summary>
        public List<_MergefieldInfo> mergeFieldInfo { get; set; }
        /// <summary>
        /// Form fields to place and position in agreement document
        /// </summary>
        public List<_RequestFormField> formFields { get; set; }
    }
}
